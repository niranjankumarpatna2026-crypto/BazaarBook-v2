...
//           <span className="grid h-9 w-9 place-items-center rounded-xl bg-gradient-to-br from-brand-600 to-accent-500 font-extrabold text-white">
//             B
//           </span>
//           <span className="font-extrabold">BazaarBook</span>
//         </div>
...
//             <span className="grid h-8 w-8 place-items-center rounded-lg bg-gradient-to-br from-brand-600 to-accent-500 text-sm font-bold text-white">
//               B
//             </span>
...
//         {/* Mobile bottom nav */}
//         <nav className="fixed inset-x-0 bottom-0 z-40 border-t border-stone-200 bg-white lg:hidden">
